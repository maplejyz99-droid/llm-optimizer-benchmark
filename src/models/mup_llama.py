...
class MuPLlama(GPTBase):
    ...
    def get_parameter_group_specs(self, config):
        """
        Split parameters into decayed and non-decayed groups, with muP width
        scaling applied to decayed matrix parameters.
        """
        ...
        width_mult = self.config.n_embd / self.config.scale_base_model
        return [
            {
                "params": sorted(list(decay)),
                "lr": self.config.lr / width_mult,  # mup change here!
            },
