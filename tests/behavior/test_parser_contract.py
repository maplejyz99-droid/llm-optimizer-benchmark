...
EXPECTED_PARSER_CONTRACTS = [
    ...
    (("--opt",), "opt", "_StoreAction", "adamw", None, ("adamw", "gn-prox", "gn-full", "cadamw", "adamw-magma", "sgd", "muon", "newton-muon", "softeq-k2000-muon", "muon-magma", "soap", "ademamix", "lion", "sf-adamw", "sf-sgd", "signsgd", "signum", "prodigy", "sophiag", "adopt", "mars", "adafactor", "lamb", "scion", "scion-light", "d-muon", "muon-pytorch"), None, False),
