...
EXPECTED_PARSER_CONTRACTS = [
    ...
    (("--auto_resume",), "auto_resume", "_StoreAction", True, None, None, None, False),
    ...
    (("--merge_dims",), "merge_dims", "_StoreAction", False, "bool", None, None, False),
    (("--precondition_1d",), "precondition_1d", "_StoreAction", False, "bool", None, None, False),
    (("--normalize_grads",), "normalize_grads", "_StoreAction", False, "bool", None, None, False),
    (("--soap_data_format",), "soap_data_format", "_StoreAction", "channels_first", "str", None, None, False),
    (("--correct_bias",), "correct_bias", "_StoreAction", True, "bool", None, None, False),
    (("--nesterov",), "nesterov", "_StoreAction", False, "bool", None, None, False),
    ...
    (("--prodigy_decouple",), "prodigy_decouple", "_StoreAction", True, "bool", None, None, False),
    (("--prodigy_use_bias_correction",), "prodigy_use_bias_correction", "_StoreAction", False, "bool", None, None, False),
    (("--prodigy_safeguard_warmup",), "prodigy_safeguard_warmup", "_StoreAction", False, "bool", None, None, False),
    (("--prodigy_fsdp_in_use",), "prodigy_fsdp_in_use", "_StoreAction", False, "bool", None, None, False),
    ...
    (("--mars_is_approx",), "mars_is_approx", "_StoreAction", True, "float", None, None, False),
    ...
    (("--lamb_use_bias_correction",), "lamb_use_bias_correction", "_StoreAction", False, "bool", None, None, False),
    (("--adopt_decouple",), "adopt_decouple", "_StoreAction", True, "bool", None, None, False),
    ...
    (("--tokenizer",), "tokenizer", "_StoreAction", "gpt2", "str", ("gpt2", "mistral"), None, False),
    ...
    (("--bias",), "bias", "_StoreAction", False, "bool", None, None, False),
