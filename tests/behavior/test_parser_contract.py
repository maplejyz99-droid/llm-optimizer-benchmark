...
EXPECTED_PARSER_CONTRACTS = [
    ...
    (("--eval_interval",), "eval_interval", "_StoreAction", 200, "positive_int", None, None, False),
    (("--full_eval_at",), "full_eval_at", "_StoreAction", None, "int", None, "+", False),
    (("--eval_batches",), "eval_batches", "_StoreAction", 64, "positive_int", None, None, False),
    (("--final_eval_batches",), "final_eval_batches", "_StoreAction", None, "positive_int", None, None, False),
    (("--final_eval_tokens",), "final_eval_tokens", "_StoreAction", None, "positive_int", None, None, False),
    (("--save_final_model",), "save_final_model", "_StoreAction", False, "strict_bool", None, None, False),
    ...
    (("--distributed_control_timeout_seconds",), "distributed_control_timeout_seconds", "_StoreAction", 86400, "positive_int", None, None, False),
    ...
    (("--sophia_estimator_mode",), "sophia_estimator_mode", "_StoreAction", "legacy_last_microbatch", None, ("legacy_last_microbatch", "global_accum"), None, False),
    (("--sophia_verify_rank_state",), "sophia_verify_rank_state", "_StoreAction", False, "strict_bool", None, None, False),
    ...
    (("--allow_dataset_download",), "allow_dataset_download", "_StoreTrueAction", False, None, None, 0, False),
    ...
    (("--from_dense",), "from_dense", "_StoreAction", True, "strict_bool", None, "?", False),
